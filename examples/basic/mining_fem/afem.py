...
print("                             a single event set is a parallel episode; one where")
print("                             every event set is a single event is a serial")
print("                             episode; the general case, combining both, is a")
print("                             composite episode.")
print()
...
print("                          be positive; roughly 1-10 is meaningful - much")
